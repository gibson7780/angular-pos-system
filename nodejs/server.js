...
router.post('/heroes', jsonParser, function (req, res) {
...
router.post('/heroes/:id/like', jsonParser, function (req, res) {
  pool.connect(function (err, client, done) {
    if (client) {
      client.query(
...
router.delete('/heroes/:id', jsonParser, function (req, res) {
